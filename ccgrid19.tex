...
The rest of this paper is organized as follows. Section~\ref{sec:orgbcf6d4e}
...
exploration strategies. Section~\ref{sec:orgbc50631} discusses the Design
of Experiments, ANOVA, and linear regression methodology we used to develop our
approach. Section~\ref{sec:orgdfa1ceb} discusses the
implementation of our approach in detail. Section~\ref{sec:org776b053}
presents the results on the GPU Laplacian Kernel and on the SPAPT benchmark
suite. Section~\ref{sec:org654632c} discusses our conclusions and future work.
\section{Background}
\label{sec:orgbcf6d4e}
...
Section~\ref{sec:org776b053} were obtained in the domain of
...
Figure~\ref{fig:orgbdde599} shows the contour of a search space defined
...
Section~\ref{sec:org776b053} can exceed 20 minutes, including the time
...
Figure~\ref{fig:orgbdde599} are based on the Design of Experiments
...
Figure~\ref{fig:orgbdde599}, a D-Optimal design using a linear model
...
as was shown in Figure~\ref{fig:orgbdde599}.
...
Figure~\ref{fig:orgba1abd1} presents an overview of our approach.

\begin{figure}[b]\vspace{-.5cm}
\centering
\includegraphics[width=.95\columnwidth]{./img/doe_anova_strategy.pdf}
\caption{\label{fig:orgba1abd1}
...
The next four steps of an iteration, shown in Figure \ref{fig:orgba1abd1},
...
\ref{tab:orgf9a3a35}. Considering only factors and levels, the size of the
...
approach, described Section~\ref{sec:orgdfa1ceb}, except
...
Figure~\ref{fig:orgb31c9ba} presents histograms with the
...
kernels shown in Table~\ref{tab:orgf0df608} are implemented using the code
...
Figure~\ref{fig:orgba1abd1}. Experiments were performed using
...
Figure~\ref{fig:org60fa593} presents the \emph{speedup} found by each
...
Figure~\ref{fig:org4b6c7f6} shows the search space exploration performed
by RS and DLMT. It uses the same color groups as
Figure~\ref{fig:org60fa593}, and shows the distribution of the
...
\caption{\label{fig:org4b6c7f6}
Histograms of explored search spaces, showing the real count of measured configurations. Kernels are grouped in the same way as in Figure~\ref{fig:org60fa593}. DLMT spent less measurements than RS in configurations with smaller speedups or with slowdowns, even for kernels in the orange group. DLMT also spent more time exploring configurations with larger speedups}
\end{figure*}

\section{Conclusion}
\label{sec:org654632c}
