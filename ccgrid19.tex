...
The rest of this paper is organized as follows. Section~\ref{sec:org0a6b8d4}
...
exploration strategies. Section~\ref{sec:org48c45f3} discusses the Design
of Experiments, ANOVA, and linear regression methodology we used to develop our
approach. Section~\ref{sec:org9c7452d} discusses the
implementation of our approach in detail. Section~\ref{sec:org4d10db0}
presents the results on the GPU Laplacian Kernel and on the SPAPT benchmark
suite. Section~\ref{sec:org5160beb} discusses our conclusions and future work.
\section{Background}
\label{sec:org0a6b8d4}
...
Section~\ref{sec:org4d10db0} were obtained in the domain of
...
Figure~\ref{fig:org4313cb7} shows the contour of a search space defined
...
Section~\ref{sec:org4d10db0} can exceed 20 minutes, including the time
...
Figure~\ref{fig:org4313cb7} are based on the Design of Experiments
...
Figure~\ref{fig:org4313cb7}, a D-Optimal design using a linear model
...
as was shown in Figure~\ref{fig:org4313cb7}.
...
Figure~\ref{fig:org3aaaad7} presents an overview of our approach.

\begin{figure}[b]\vspace{-.5cm}
\centering
\includegraphics[width=.95\columnwidth]{./img/doe_anova_strategy.pdf}
\caption{\label{fig:org3aaaad7}
...
The next four steps of an iteration, shown in Figure \ref{fig:org3aaaad7},
...
\ref{tab:org157c652}. Considering only factors and levels, the size of the
...
approach, described Section~\ref{sec:org9c7452d}, except
...
Figure~\ref{fig:orgac26eca} presents histograms with the
...
Figure~\ref{fig:org3aaaad7}. Experiments were performed using
...
Figure~\ref{fig:orgb238550} presents the \emph{speedup} found by each
...
Figure~\ref{fig:org68042b7} shows the search space exploration performed
by RS and DLMT. It uses the same color groups as
Figure~\ref{fig:orgb238550}, and shows the distribution of the
...
\caption{\label{fig:org68042b7}
Histograms of explored search spaces, showing the real count of measured configurations. Kernels are grouped in the same way as in Figure~\ref{fig:orgb238550}. DLMT spent fewer measurements than RS in configurations with smaller speedups or with slowdowns, even for kernels in the orange group. DLMT also spent more time exploring configurations with larger speedups}
\end{figure*}

\section{Conclusion}
\label{sec:org5160beb}
