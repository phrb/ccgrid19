...
and industrial HPC applications, which makes autotuning
...
their possible values. They are also difficult to explore extensively due to the
...
The rest of this paper is organized as follows. Section~\ref{sec:org5086915}
...
exploration strategies. Section~\ref{sec:orge5b81e1} discusses the Design
of Experiments, ANOVA, and linear regression methodology we used to develop our
approach. Section~\ref{sec:org76e8ee0} discusses the
implementation of our approach in detail. Section~\ref{sec:org89511aa}
presents the results on the GPU Laplacian Kernel and on the SPAPT benchmark
suite. Section~\ref{sec:orgb34474a} discusses our conclusions and future work.
\section{Background}
\label{sec:org5086915}
...
Section~\ref{sec:org89511aa} were obtained in the domain of
...
Figure~\ref{fig:org1511305} shows the contour of a search space defined
...
Section~\ref{sec:org89511aa} can exceed 20 minutes, including the time
...
Figure~\ref{fig:org1511305} are based on the Design of Experiments
...
Figure~\ref{fig:org1511305}, a D-Optimal design using a linear model
...
as was shown in Figure~\ref{fig:org1511305}.
...
Figure~\ref{fig:orgfb84e1e} presents an overview of our approach.

\begin{figure}[b]\vspace{-.5cm}
\centering
\includegraphics[width=.95\columnwidth]{./img/doe_anova_strategy.pdf}
\caption{\label{fig:orgfb84e1e}
...
The next four steps of an iteration, shown in Figure \ref{fig:orgfb84e1e},
...
\ref{tab:org6493d2e}. Considering only factors and levels, the size of the
...
approach, described Section~\ref{sec:org76e8ee0}, except
...
Figure~\ref{fig:org0a29227} presents histograms with the
...
Figure~\ref{fig:orgfb84e1e}. Experiments were performed using
...
Figure~\ref{fig:orgf8e2700} presents the \emph{speedup} found by each
...
Figure~\ref{fig:orgb34feac} shows the search space exploration performed
by RS and DLMT. It uses the same color groups as
Figure~\ref{fig:orgf8e2700}, and shows the distribution of the
...
\caption{\label{fig:orgb34feac}
Histograms of explored search spaces, showing the real count of measured configurations. Kernels are grouped in the same way as in Figure~\ref{fig:orgf8e2700}. DLMT spent fewer measurements than RS in configurations with smaller speedups or with slowdowns, even for kernels in the orange group. DLMT also spent more time exploring configurations with larger speedups}
\end{figure*}

\section{Conclusion}
\label{sec:orgb34474a}
