...
The rest of this paper is organized as follows. Section~\ref{sec:org3655c2f}
...
exploration strategies. Section~\ref{sec:orgab06c20} discusses the Design
of Experiments, ANOVA, and linear regression methodology we used to develop our
approach. Section~\ref{sec:org380a956} discusses the
implementation of our approach in detail. Section~\ref{sec:org01d407a}
presents the results on the GPU Laplacian Kernel and on the SPAPT benchmark
suite. Section~\ref{sec:org7a9246b} discusses our conclusions and future work.
\section{Background}
\label{sec:org3655c2f}
...
Section~\ref{sec:org01d407a} were obtained in the domain of
...
Figure~\ref{fig:orgbd15627} shows the contour of a search space defined
...
Section~\ref{sec:org01d407a} can exceed 20 minutes, including the time
...
Figure~\ref{fig:orgbd15627} are based on the Design of Experiments
...
Figure~\ref{fig:orgbd15627}, a D-Optimal design using a linear model
...
as was shown in Figure~\ref{fig:orgbd15627}.
...
Figure~\ref{fig:orgcf298b5} presents an overview of our approach.

\begin{figure}[b]\vspace{-.5cm}
\centering
\includegraphics[width=.95\columnwidth]{./img/doe_anova_strategy.pdf}
\caption{\label{fig:orgcf298b5}
...
The next four steps of an iteration, shown in Figure \ref{fig:orgcf298b5},
...
\ref{tab:org752fc19}. Considering only factors and levels, the size of the
...
approach, described Section~\ref{sec:org380a956}, except
...
Figure~\ref{fig:org5042b2c} presents histograms with the
...
kernels shown in Table~\ref{tab:orgaac8513} are implemented using the code
...
Figure~\ref{fig:orgcf298b5}. Experiments were performed using
...
Figure~\ref{fig:org5c565b7} presents the \emph{speedup} found by each
...
Figure~\ref{fig:org1bccc93} shows the search space exploration performed
by RS and DLMT. It uses the same color groups as
Figure~\ref{fig:org5c565b7}, and shows the distribution of the
...
\caption{\label{fig:org1bccc93}
Histograms of explored search spaces, showing the real count of measured configurations. Kernels are grouped in the same way as in Figure~\ref{fig:org5c565b7}. DLMT spent less measurements than RS in configurations with smaller speedups or with slowdowns, even for kernels in the orange group. DLMT also spent more time exploring configurations with larger speedups}
\end{figure*}

\section{Conclusion}
\label{sec:org7a9246b}
